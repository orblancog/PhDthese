...
\begin{figure}[hbt]
\centering
  \includegraphics[scale=0.3,angle=0]{fig23.pdf}\caption{BPM coordinate system centered ellectrically. {\color{red}Beam in red}, {\color{forestgreen} BPMs in green}.}\label{f:BPMcoordinate}
\end{figure}
